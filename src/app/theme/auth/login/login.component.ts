...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.defAppDesc = DefaultConfig.Application.appDesc;
  ...
  doLogin(e) {
    ...
    //       password: this.loginForm.value.password,
    //     };
    //     this.oauthService.getAccessToken(body).subscribe(
    //       (res) => {
    //         if (res) {
    ...
    //         this.broadcasterService.notifBroadcast(true, {
    //           title: "Login Failed",
    //           msg: this.getErrMsg(err.error.meta.message),
    //           timeout: 5000,
    //           theme: "bootstrap",
    //           position: "top-right",
    //           type: "error",
