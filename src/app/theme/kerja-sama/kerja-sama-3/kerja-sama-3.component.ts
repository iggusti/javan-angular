...
@Component({
  selector: "app-kerja-sama-3",
  templateUrl: "./kerja-sama-3.component.html",
  styleUrls: ["./kerja-sama-3.component.scss"],
})
export class KerjaSama3Component implements OnInit {
