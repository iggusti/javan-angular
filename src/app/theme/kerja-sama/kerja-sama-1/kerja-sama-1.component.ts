...
@Component({
  selector: "app-kerja-sama-1",
  templateUrl: "./kerja-sama-1.component.html",
  styleUrls: ["./kerja-sama-1.component.scss"],
})
export class KerjaSama1Component implements OnInit {
