...
@Component({
  selector: "app-kerja-sama-10",
  templateUrl: "./kerja-sama-10.component.html",
  styleUrls: ["./kerja-sama-10.component.scss"],
})
export class KerjaSama10Component implements OnInit {
