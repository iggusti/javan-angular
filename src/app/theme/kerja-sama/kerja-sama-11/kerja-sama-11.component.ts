...
@Component({
  selector: "app-kerja-sama-11",
  templateUrl: "./kerja-sama-11.component.html",
  styleUrls: ["./kerja-sama-11.component.scss"],
})
export class KerjaSama11Component implements OnInit {
