...
@Component({
  selector: "app-kerja-sama-8",
  templateUrl: "./kerja-sama-8.component.html",
  styleUrls: ["./kerja-sama-8.component.scss"],
})
export class KerjaSama8Component implements OnInit {
