...
@Component({
  selector: "app-kerja-sama-6",
  templateUrl: "./kerja-sama-6.component.html",
  styleUrls: ["./kerja-sama-6.component.scss"],
})
export class KerjaSama6Component implements OnInit {
  ...
  public chartConfig = {
    ...
    title: {
      text: "Jumlah Perolehan Dana Kerja Sama Internasional Dalam Milyar Rupiah",
      align: "center",
    },
    tooltip: {
      theme: "light",
